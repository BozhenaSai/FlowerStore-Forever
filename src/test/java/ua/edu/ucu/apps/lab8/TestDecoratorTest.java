...
public class TestDecoratorTest {
    ...
    public void testPaper() {
        ...
        assertEquals(paperWrappedFlower.getDescription(), "Cactus now is wrapped in paper.");   
    }
    ...
    public void testBasket() {
        ...
        assertEquals(paperWrappedFlower.getDescription(), "Cactus now is in a basket.");   
    }
    ...
    public void testRibbon() {
        ...
        assertEquals(paperWrappedFlower.getDescription(), "Cactus now has a ribbon.");   
    }
}